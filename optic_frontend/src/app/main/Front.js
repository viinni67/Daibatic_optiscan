...
function Front() {
    ...
    // Example: Changing src on client-side only
    useEffect(() => {
        setImgSrc("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR72ixAIQnCZP2he-MRVeM8EJD_XghAupERzw&s"); // Update this to your desired image
    }, []);
    return (
        <div>
            <nav className="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                        {/* // Render the img tag only if imgSrc is set */}
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR72ixAIQnCZP2he-MRVeM8EJD_XghAupERzw&s" className="h-8" alt="Opti-Scan Logo" />

                        {/* <img src={imgSrc} className="h-8" alt="Flowbite Logo" /> */}
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Opti-Scan</span>
                    </a>
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                        <ul className="flex flex-coln font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                            <li>
